...
Fit the model, save to object `fit`
Run `summary()` to see high level results
...
```{r}
  data <- data.frame(x1 = rnorm(1000, 10, 5), x2 = rnorm(1000, 20, 35), x3 = rnorm(1000, 14, 1), x1 = rnorm(1000, 100, 200))
```

...
##If Statement
Suppose you're examining a dataset and find erroneous or missing values. After some examination and brilliant thinking you develop a way to handle those values. However, it requires 
```{r, eval=FALSE}
if(statement){
...
We can do the same for a vector or list of values. In the example below, the vector `news` contains six terms. Using a forloop, we can print out each word in the vector.

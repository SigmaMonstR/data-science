...
### (3) Algorithm
Algorithms are a series of rules and calculations used to convert data into insight. Supervised learning algorithms are typically comprised of a learning function, a loss function, and a hyperparameters. A learning function 

When putting the data together, $y$ can be expressed as a function of $x$:  $y_i = f(x_{1,i}, x_{2,i},..., x_{k,i})$. These functions .

 Techniques are concerned with the treatment of the type of labeled data, which has particular influence on the structure and assumptions of mathematical operations. In supervised learning, there are two broad categories of algorithms, including:  

...
The role of data in public policy can and should move beyond just scatter plots and trend lines. It can help uncover patterns so that decision makers can be informed in strategic decision making, be directly applied into the field, and drive change or help maintain stability. 


The formulation of data science problems can take on a number of forms. 

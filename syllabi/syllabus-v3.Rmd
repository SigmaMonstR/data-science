...
subtitle: Jeff Chen ([jc2817@georgetown.edu](mailto:jc2817@georgetown.edu)) and Dan
  Hammer ([dan.hammer@georgetown.edu](mailto:dan.hammer@georgetown.edu))
output:
...
- Lec 9: Write README for class project and provide any other indication of progress on project (e.g. preliminary models, prototype libraries, etc.). Due Lec 10.

#### Section 3: BEYOND MODELING
...
##### Lecture 10: Database querying (SQL) and Websites (HTML/CSS)
...
##### Lecture 11: Spatial Data and Web Services
...
1. 	Understand the ecosystem of actors (e.g. data scientists, engineers, designers, data base administrators, etc.) who work in the data and technology space.
2.  Set up and task an Amazon Web Services machine for parallel processing tasks.
...
1. 	Basic syntax
2.  Installation of Python (Anacondas)
3.  Create a iPython Notebook
